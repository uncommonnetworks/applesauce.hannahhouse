...
<ul class="nav navbar-nav">
    ...
    --}}
    <li>
        <a href="{{ Route('strikes') }}">Strikes</a>
    </li>
    <li>
        <a href="{{ Route('suspensions') }}">Suspensions</a>
    </li>
    <li>
        <a href="{{ Route('bedding') }}">Bedding</a>
    </li>

    <li>
        <a href="{{ Route('lockers') }}">Lockers</a>
    </li>
    ...
    <li class="dropdown">
        <a href="#" data-toggle="dropdown"></i><span class="mm-text">Downloads</span></a>
        <ul class="dropdown-menu">
            <li>
                <a tabindex="-1" href="report/meals-checklist"><span class="mm-text">Meals Checklist</span></a>
            </li>
            <li>
...
<li class="dropdown">
    ...
    <ul class="dropdown-menu">
        ...
        <li class="divider"></li>-->
        <li><a href="/users/logout"><i class="dropdown-icon fa fa-power-off"></i>&nbsp;&nbsp;Log Out</a></li>
    </ul>
</li>
</ul> <!-- / .navbar-nav -->
</div> <!-- / .right -->
